...
qqnorm(Mexico5yrarima_garch_stdres, main="Q-Q Plot of ARMA-GARCH")
qqline(Mexico5yrarima_garch_stdres)
...
qqnorm(Mexico10yrarima_res, main="Q-Q Plot of ARMA-GARCH")
...
Acf(Mexico10yrarima_res^2, main='ACF of ARIMA Res^2')
Acf(Mexico10yrarima_garch_stdres^2, main='ACF of ARMA-GARCH Res^2')

Acf(Mexico10yrarima_res, main='ACF of ARIMA Res')
Acf(Mexico10yrarima_garch_stdres, main='ACF of ARMA-GARCH Res')
